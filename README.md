...
The application comes with 6 pre-loaded quizzes:

1. **JavaScript Fundamentals** (50 questions)
   - Variable declarations, operators, array methods
   
2. **World Geography** (50 questions)
   - Capitals, continents, rivers, mountains
   
3. **Science Basics** (50 questions)
   - Physics, chemistry, biology concepts
   
4. **React Development** (50 questions)
   - JSX, hooks, component lifecycle
   
5. **General Knowledge** (50 questions)
   - Space, art, geography, world records

6. **Movies & Series** (50 questions)
   - Movies, Series, world records
